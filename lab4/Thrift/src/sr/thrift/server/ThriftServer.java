...
//			TProtocolFactory protocolFactory = new TCompactProtocol.Factory();
			...
			TServer server1 = new TSimpleServer(new Args(serverTransport).protocolFactory(protocolFactory).processor(processor3).processor(processor1).processor(processor2));
