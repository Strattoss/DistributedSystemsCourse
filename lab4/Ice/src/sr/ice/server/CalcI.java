...
public class CalcI implements Calc {
	...
	public long add(int a, int b, Current __current) {
		...
		System.out.println("Client's name: " + __current.id.name + ", category:" + __current.id.category);
	...
	@Override
	public double avg(long[] longArray, Current current) throws EmptyArrayException {
		var result = Arrays.stream(longArray).average();
		if (result.isEmpty()) {
