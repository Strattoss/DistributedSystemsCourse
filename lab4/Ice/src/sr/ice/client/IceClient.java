...
import Demo.A;
import Demo.CalcPrx;
import Demo.EmptyArrayException;
...
public class IceClient {
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println("--- Calling two different objects");
			...
			long r;
			A a;
			long[] longArray = new long[] {0, 1, 1, 2, 3, 5, 8, 13, 21, 35, 56};
			double longAvg;
			...
			do {
				try {
					...
					switch (line) {
						...
						case "avg":
							longAvg = obj1.avg(longArray);
							System.out.println("RESULT = " + longAvg);
							break;

						case "avg error":
							long[] emptyLongArray = new long[] {};
							try {
								longAvg = obj1.avg(emptyLongArray);
								System.out.println("RESULT = " + longAvg);
							} catch (EmptyArrayException e) {
								System.out.println("Exception caught: " + e.reason);
							}
							break;
