...
public interface CalcPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    default void sum(long[] longArray)
    {
        sum(longArray, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default void sum(long[] longArray, java.util.Map<String, String> context)
    {
        _iceI_sumAsync(longArray, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<Void> sumAsync(long[] longArray)
    {
        return _iceI_sumAsync(longArray, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> sumAsync(long[] longArray, java.util.Map<String, String> context)
    {
        return _iceI_sumAsync(longArray, context, false);
    }

    /**
     * @hidden
     * @param iceP_longArray -
     * @param context -
     * @param sync -
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_sumAsync(long[] iceP_longArray, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<Void> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "sum", null, sync, null);
        f.invoke(false, context, null, ostr -> {
                     ostr.writeLongSeq(iceP_longArray);
                 }, null);
        return f;
    }
