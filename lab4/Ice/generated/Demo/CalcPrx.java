...
public interface CalcPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    default double avg(long[] longArray)
        throws EmptyArrayException
    {
        return avg(longArray, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default double avg(long[] longArray, java.util.Map<String, String> context)
        throws EmptyArrayException
    {
        try
        {
            return _iceI_avgAsync(longArray, context, true).waitForResponseOrUserEx();
        }
    ...
    default java.util.concurrent.CompletableFuture<java.lang.Double> avgAsync(long[] longArray)
    {
        return _iceI_avgAsync(longArray, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.lang.Double> avgAsync(long[] longArray, java.util.Map<String, String> context)
    {
        return _iceI_avgAsync(longArray, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<java.lang.Double> _iceI_avgAsync(long[] iceP_longArray, java.util.Map<String, String> context, boolean sync)
    {
