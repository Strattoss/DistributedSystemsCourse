...
public final class CalculatorGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<sr.grpc.gen.MultiplicationArguments,
      sr.grpc.gen.MultiplicationReturn> getMultiplyMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Multiply",
      requestType = sr.grpc.gen.MultiplicationArguments.class,
      responseType = sr.grpc.gen.MultiplicationReturn.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<sr.grpc.gen.MultiplicationArguments,
      sr.grpc.gen.MultiplicationReturn> getMultiplyMethod() {
    io.grpc.MethodDescriptor<sr.grpc.gen.MultiplicationArguments, sr.grpc.gen.MultiplicationReturn> getMultiplyMethod;
    if ((getMultiplyMethod = CalculatorGrpc.getMultiplyMethod) == null) {
      synchronized (CalculatorGrpc.class) {
        if ((getMultiplyMethod = CalculatorGrpc.getMultiplyMethod) == null) {
          CalculatorGrpc.getMultiplyMethod = getMultiplyMethod =
              io.grpc.MethodDescriptor.<sr.grpc.gen.MultiplicationArguments, sr.grpc.gen.MultiplicationReturn>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  sr.grpc.gen.MultiplicationReturn.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    default void multiply(sr.grpc.gen.MultiplicationArguments request,
        io.grpc.stub.StreamObserver<sr.grpc.gen.MultiplicationReturn> responseObserver) {
  ...
  public static final class CalculatorBlockingStub
    ...
    /**
     */
    public sr.grpc.gen.MultiplicationReturn multiply(sr.grpc.gen.MultiplicationArguments request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class CalculatorFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<sr.grpc.gen.MultiplicationReturn> multiply(
        ...
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              ...
              sr.grpc.gen.MultiplicationReturn>(
